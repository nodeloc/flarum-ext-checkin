...
class CheckinListener
{
    ...
    public function __construct(SettingsRepositoryInterface $settings, ConnectionInterface $connection, Grammar $grammar, Dispatcher $events, TranslatorInterface $translator, CheckinValidator $validator)
    {
